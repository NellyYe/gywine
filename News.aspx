    ...
    <div id="content_right">
        <div class="about">
            <div class="title">
                <h3>企业新闻</h3>
                <span>
                    您的位置：<a href="Default.aspx">首页</a> &gt;&gt; 企业新闻
                </span>     
            </div>
            <div>
<asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource2">
                    <ItemTemplate>
                        ...
                        <tr>
                            <td><a href="#" style="float: left; color:Black"><%#Eval("添加内容") %></a></td>
                            <td><a style="float: right"><%#Eval("更新时间") %></a></td>
                        </tr>
                        </div>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:jiuConnectionString5 %>" 
                    SelectCommand="SELECT [添加内容], [更新时间] FROM [news]"></asp:SqlDataSource>
