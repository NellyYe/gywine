<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Honor.aspx.cs" Inherits="Honor" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        * { margin: 0; padding: 0; list-style: none; }
        ...
        .cont .pic ul{width:750px; padding:0; margin:0 auto; height:100%; clear:both;overflow: hidden;position: relative;}
        .cont .pic li{width:220px;padding:0;margin:0 10px 0 10px;text-align:center; padding:0; float:left; display:block;}
        .cont .pic img{max-width:220px;max-height:220px;border: 0;display:inline!important;margin: 20px;}
    ...
    <div id="content_right">
        <div class="about">
            <div class="title">
                <h3>资质荣誉</h3>
                <span>
                    您的位置：<a href="Default.aspx">首页</a> &gt;&gt; 资质荣誉
                </span>
            </div>
            <div class="cont">
                <div class="pic">
