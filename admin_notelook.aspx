<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_notelook.aspx.cs" Inherits="admin_notelook" %>
...
<table class="tableBorder" id="table2" cellSpacing="1" cellPadding="3" border="0"
					...
					<tr>
						...
						<td width="20%" align="center" class="forumRow" style="height: 25px"><strong>用户名</strong></td>
						<td class="forumRow" align="center" width="20%" style="height: 25px"><strong>留言</strong></td>
        ...
        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" >
							...
							<tr>
								...
								<td width="10%" height="20" align="center"><%#DataBinder.Eval(Container.DataItem,"用户名")%></td>
								<td width="10%" height="20" align="center"><%#DataBinder.Eval(Container.DataItem,"留言内容")%></td>
