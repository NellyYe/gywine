   ...
   <title>高阳酒业网</title>
    <style type="text/css">
        ...
        * { margin: 0; padding: 0; list-style: none; }
        ...
        /*正文右侧*/
       #content_right{width:735px;height: 400px;float:right;padding-top:5px;}
        /*联系方式*/
        .contact{width:735px;height:auto;}
        .title{
            background: url("../images_bg_r.gif")bottom repeat-x;
    ...
    <div id="content_right">
        <div class="contact">
            <div class="title">
                <h3>给我们留言</h3>
                <span>
                    您的位置：<a href="Default.aspx">首页</a> &gt;&gt; 给我们留言
                </span>
            </div>
            <div>
                <table style="width: 100%;border: 0;align:center;mso-cellspacing:5">
                    <tr>
                        <td align="right">称呼： </td>
                        <td align="left">
                           &nbsp;<asp:TextBox ID="tb_names" runat="server" Width="180px" ReadOnly="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">留言内容：</td>
                        <td align="left">
                            &nbsp;<asp:TextBox ID="tb_note" runat="server" Height="97px" 
                    ...
                    <tr>
                        <td align="right">&nbsp;</td>
                        <td align="left">
                        &nbsp;<asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="提交" Width="76px" />
                        </td>
                  </tr>
                </table>
            </div>      
